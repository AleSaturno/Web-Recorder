...
<head>
    ...
    <title>Recorder Video-Clase</title>
</head>
<body>
    ...
    <div class="Botonera">
        <div class="Rectangle-5">
            ...
            <button class="Rectangle-17">
                ...
                <ul>
                    <li>
                        <a href="Recorder Video-Clase.php">Detener Todo</a>
                    </li>
                </ul>
            </button> 
        </div>
        ...
        <div class="Interfaz-Funciones">
            ...
            <div class="Abrir-Cam-Mic">
                ...
                <div class="Frame-2" id="Frame-2">
                    <img src="images/camara apagada.png" alt="Camara">
                </div>
        ...
        <!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////     -->
            <div class="Abrir-Cam-Mic-2">
                ...
                <span class="El-primer-paso-para-realizar-la-grabacin-de-tu-video-clase-es-iniciar-tu-cmara-y-micrfono-2">
                    Al hacer click debajo si tienes un micrófono automáticamente podrás hacer la prueba de sonido (Si usa altavoces corre el riesgo de que el audio se acople).
                </span>
        ...
        <div class="Interfaz-Funciones-3">
            ...
            <div class="Abrir-Cam-Mic-4">
                ...
                <span class="El-primer-paso-para-realizar-la-grabacin-de-tu-video-clase-es-iniciar-tu-cmara-y-micrfono-4">
                    El tercer paso para realizar la grabación de tu video-clase es previsualizar como quedaría el video.
                </span>
